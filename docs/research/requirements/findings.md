...
|---|---|---|
| Wabbajack metadata / manifest | <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/modlists.json> | Candidate inventory and manifest context |
| GitHub README | <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/README.md> | Installation, version, environment, optional, and conflict statements |
| GitHub InstallationGuide | <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/InstallationGuide.md> | Prerequisite and environment statements |
| GitHub MOD_NOTES | <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/MOD_NOTES.md> | Author notes and requirement statements |
...
| Smorgasbord / `new save` | README sentence 167, <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/README.md> | `Updating the Mod List may require a new save` | `environment condition` | Save/environment condition, not a MOD dependency |
| Smorgasbord / `Advanced Weapons Repair Kit` | MOD_NOTES sentence 29, <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/MOD_NOTES.md> | `Some Tier 3 and all Tier 4 Weapons require the Advanced Weapons Repair Kit.` | `explicit requirement` | Candidate with unresolved target identity |
| Smorgasbord / overhaul targets | MOD_NOTES sentence 72, <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/MOD_NOTES.md> | `This Mod List is not compatible with the main EFT Overhaul, Rebirth, Darkness Falls, nor most other Overhauls.` | `declared conflict` | Declared conflict, not a dependency |
| Smorgasbord / `VC++ Redistributable` | InstallationGuide, `Prerequisites`, <https://raw.githubusercontent.com/ANONYMIZED_AUTHOR/Smorgasbord/main/InstallationGuide.md> | `VC++ Redistributable` | `prerequisite` | Environment requirement, non-MOD target |
